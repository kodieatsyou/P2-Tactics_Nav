...
Reachable set computation (Dijkstra, movement budget)

Line-of-Sight raycasting (supercover grid tracing)

Influence / threat heatmap

Multi-factor tactical tile evaluation
